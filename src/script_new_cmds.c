...
u16 ALIGN4 NewMarts[][24] = 
{
	...
	{ITEM_LIGHT_CLAY, ITEM_ICY_ROCK, ITEM_SMOOTH_ROCK, ITEM_HEAT_ROCK, ITEM_DAMP_ROCK, ITEM_ELECTRIC_SEED, ITEM_GRASSY_SEED, ITEM_MISTY_SEED, ITEM_PSYCHIC_SEED, ITEM_TERRAIN_EXTENDER, ITEM_SAFETY_GOGGLES, ITEM_UTILITY_UMBRELLA, 0xFFFF}, //entry 2 - Olivine Beach Weather Items
	{ITEM_KINGS_ROCK, ITEM_DEEP_SEA_TOOTH, ITEM_DEEP_SEA_SCALE, ITEM_METAL_COAT, ITEM_DRAGON_SCALE, ITEM_HARD_STONE, ITEM_BLACK_BELT, ITEM_MAGNET, ITEM_SPELL_TAG, ITEM_TWISTED_SPOON, ITEM_UP_GRADE, ITEM_PROTECTOR, ITEM_ELECTIRIZER, ITEM_MAGMARIZER, ITEM_DUBIOUS_DISC, ITEM_REAPER_CLOTH, ITEM_RAZOR_CLAW, ITEM_RAZOR_FANG, ITEM_PRISM_SCALE, ITEM_BLACK_AUGURITE, 0xFFFF}, //entry 3 - Safari Gate Evo Items
	{ITEM_TOXIC_ORB, ITEM_FLAME_ORB, ITEM_IRON_BALL, ITEM_LAGGING_TAIL, ITEM_BLACK_SLUDGE, ITEM_RING_TARGET, ITEM_DESTINY_KNOT, ITEM_STICKY_BARB, ITEM_SHED_SHELL, ITEM_ABSORB_BULB, ITEM_CELL_BATTERY, ITEM_EJECT_BUTTON, ITEM_RED_CARD, ITEM_LUMINOUS_MOSS, ITEM_SNOWBALL, ITEM_ADRENALINE_ORB, ITEM_BLUNDER_POLICY, ITEM_EJECT_PACK, ITEM_ROOM_SERVICE, 0xFFFF}, //entry 4 - Mahogany FIghtin' Grandma
	{ITEM_EXPERT_BELT, ITEM_LIFE_ORB, ITEM_ROCKY_HELMET, ITEM_ASSAULT_VEST, ITEM_PROTECTIVE_PADS, ITEM_HEAVY_DUTY_BOOTS, ITEM_CLEAR_AMULET, ITEM_COVERT_CLOAK, ITEM_WEAKNESS_POLICY, 0xFFFF}, //entry 4 - Blackthorn Ace Shop
};
...
u16 ALIGN4 BerryMarts[][24] = 
{
	...
	{ITEM_LIECHI_BERRY, ITEM_GANLON_BERRY, ITEM_SALAC_BERRY, ITEM_PETAYA_BERRY, ITEM_APICOT_BERRY, ITEM_LANSAT_BERRY, ITEM_STARF_BERRY, ITEM_MICLE_BERRY, ITEM_CUSTAP_BERRY, ITEM_JABOCA_BERRY, ITEM_ROWAP_BERRY, ITEM_KEE_BERRY, ITEM_MARANGA_BERRY, 0xFFFF}, //entry 2 - Pinch Berries
