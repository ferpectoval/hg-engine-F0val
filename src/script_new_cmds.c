...
u16 ALIGN4 BerryMarts[][24] = 
{
	...
	{ITEM_POMEG_BERRY, ITEM_KELPSY_BERRY, ITEM_QUALOT_BERRY, ITEM_HONDEW_BERRY, ITEM_GREPA_BERRY, ITEM_TAMATO_BERRY, ITEM_DURIN_BERRY, 0xFFFF}, //entry 1 - EV Berries
	{ITEM_OCCA_BERRY, ITEM_PASSHO_BERRY, ITEM_WACAN_BERRY, ITEM_RINDO_BERRY, ITEM_YACHE_BERRY, ITEM_CHOPLE_BERRY, ITEM_KEBIA_BERRY, ITEM_SHUCA_BERRY, ITEM_COBA_BERRY, ITEM_PAYAPA_BERRY, ITEM_TANGA_BERRY, ITEM_CHARTI_BERRY, ITEM_KASIB_BERRY, ITEM_HABAN_BERRY, ITEM_COLBUR_BERRY, ITEM_BABIRI_BERRY, ITEM_ROSELI_BERRY, ITEM_CHILAN_BERRY, ITEM_ENIGMA_BERRY, 0xFFFF}, //entry 2 - Resist berries
	{ITEM_LIECHI_BERRY, ITEM_GANLON_BERRY, ITEM_SALAC_BERRY, ITEM_PETAYA_BERRY, ITEM_APICOT_BERRY, ITEM_LANSAT_BERRY, ITEM_STARF_BERRY, ITEM_MICLE_BERRY, ITEM_CUSTAP_BERRY, ITEM_JABOCA_BERRY, ITEM_ROWAP_BERRY, 0xFFFF}, //entry 3 - Pinch Berries
};
...
BOOL Script_RunNewCmd(SCRIPTCONTEXT *ctx) {
    ...
    switch (sw) {
		...
		case SCRIPT_NEW_MARTS:;
			*(u32 *)(0x020FBA60) = (u32)NewMarts[0];
			*(u32 *)(0x020FBA88) = (u32)NewMarts[1];
			break;
